...
# 指定密钥路径（与 fstab 中的 keydirectory 一致）
TW_CRYPTO_SYSTEM_VOLD_METADATA_ENCRYPTION := true
TW_CRYPTO_SYSTEM_VOLD_KEY_DIR := /metadata/vold/metadata_encryption

# 高通平台 ICE 加密支持
TW_USE_FSCRYPT_ICE := true
